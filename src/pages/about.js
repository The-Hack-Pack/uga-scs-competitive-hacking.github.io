        ...
        <div style={{ maxWidth: '1200px', margin: '20px auto', textAlign: 'center' }}>
          <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: '0 0 30%', margin: '10px' }}>
              <img src="img/divesh.webp" alt="Divesh Gupta" style={{ width: '70%', height: 'auto', borderRadius: '20%' }} />
            ...
            <div style={{ flex: '0 0 30%', margin: '10px' }}>
              <img src="img/ethan.webp" alt="Ethan Mund" style={{ width: '70%', height: 'auto', borderRadius: '20%' }} />
            ...
            {/* Second Row */}
            <div style={{ flex: '0 0 30%', margin: '10px' }}>
              <img src="img/cole.webp" alt="Cole Nangle" style={{ width: '70%', height: 'auto', borderRadius: '20%' }} />
            ...
            <div style={{ flex: '0 0 30%', margin: '10px' }}>
              <img src="img/aparna.webp" alt="Aparna Sajith" style={{ width: '70%', height: 'auto', borderRadius: '20%' }} />
            ...
            <div style={{ flex: '0 0 30%', margin: '10px' }}>
              <img src="img/sriram.webp" alt="SriRam Surisetty" style={{ width: '70%', height: 'auto', borderRadius: '20%' }} />
